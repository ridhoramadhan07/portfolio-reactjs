...
const Contact: React.FC = () => {
  const notifySuccess = () => {
    toast.success('Berhasil Mengiriim!', {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .sendForm('service_x7dwaxr', 'template_6st4sf7', form.current as HTMLFormElement, {
        publicKey: 'f1O1-CCHVyUYLvmqn',
      })
      .then(
        () => {
          notifySuccess();
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">Ridho Ramadhan</span>
              <a href="mailto:ridhoramadhan07november@gmail.com" className="contact__button">
                {' '}
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">082230149617</span>
              <a href="https://api.whatsapp.com/send?phone=6282230149617" className="contact__button">
                {' '}
                Write Me
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Ridho Ramadhan</span>
              <a href="https://m.me/ridho.ramadhan" className="contact__button">
                {' '}
                Write Me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
