...
import CV from '../../assets/CV-RidhoRamadhan.pdf';
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            I am a web developer with skills in both front-end and back-end development. My expertise is particularly strong in front-end web development. I have worked on several projects both during and outside my time at university.
          </p>
